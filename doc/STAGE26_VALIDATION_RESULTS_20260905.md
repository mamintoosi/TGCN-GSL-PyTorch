...
- **GatedMulti beats NoGraph in 5/5 seeds** — 14.9% average improvement
- **MultiGraph beats NoGraph in 5/5 seeds** — 8.4% average improvement
- **GatedMulti beats MultiGraph in 5/5 seeds** — 7.1% average improvement
...
| **GatedMulti** | **64** | **17,091** | **4.458** |

### Key Findings

- Adding 35% more parameters to NoGraph improves RMSE by only **0.1%** (0.006 RMSE)
- GatedMulti improves by **13.3%** (0.685 RMSE)
...
| NoGraph | 207 | 5.143 | +0.0% |

### Key Findings

- **All 3 lags contribute** — the full combination is best
- Each individual lag gives ~10% improvement over NoGraph
...
1. **The GatedMultiGraphTGCN result is REAL and ROBUST**
