...
\begin{enumerate}
    ...
    \item \textbf{Prediction horizons:} Results are reported for horizons PH=1--4; the 15-minute-sampling variant covers the same four horizon counts (15--60 minutes ahead). Horizon counts beyond 4 were not evaluated.
\end{enumerate}
