...
\begin{enumerate}
    ...
    \item T-GCN-MultiGSL-Mix exploits these lag-specific graphs through per-node, per-timestep learned mixing, achieving a mean RMSE improvement of 14.9\% over a no-graph baseline on Los-loop across five random seeds.
