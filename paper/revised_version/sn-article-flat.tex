...
The comparison between static-union GCN and lag-specific T-GCN provides
evidence about the interaction between learned-graph use and backbone
architecture, but it does not isolate incorporation strategy independently
of the backbone.
\end{itemize}
