...
RMSE). RandTopK and CorrTopK are T-GCN with $K$ random or top-correlation
directed edges. Graph-free baseline and Stage~40 MultiGSL/Mix at $K=30$
are shown for reference.}
\label{tab:sparsity-sweep}
\small
\begin{tabular}{lcc}
\toprule
Configuration & RMSE & vs graph-free \\
\midrule
Graph-free baseline & $5.23\pm 0.10$ & --- \\
...
T-GCN-MultiGSL-Mix ($K{=}30$, Stage~40) & $4.49\pm 0.14$ & $-14.2\%$ \\
\bottomrule
\end{tabular}
\end{table}
