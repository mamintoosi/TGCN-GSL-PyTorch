...
\begin{itemize}
    ...
    \item \textbf{Stronger controls.} We added matched edge-budget sparsity controls, an edge-budget sweep, a capacity check, structure figures, and an identity (no-graph) reference so that gains cannot be attributed only to sparsity or to removing a dense physical graph.
