\documentclass[sn-mathphys,cntvars]{sn-jnl}
\input{commands}

\begin{document}

\title{Graph Structure Learning for Traffic Prediction}

\author*[1,2]{Mahmoud Mamintoosi}\corresp[mahmood.mamintoosi@gmail.com]{Corresponding author}
\author[1]{Mehdi Ghassemi}
\author[3]{Mahdi Farnaghi}

\affil*[1]{Department of Computer Engineering, Mashhad Branch, Islamic Azad University, Mashhad, Iran}
\affil[2]{Borujen Branch, Islamic Azad University, Borujen, Iran}
\affil[3]{Department of GIS and Remote Sensing, University of Tehran, Tehran, Iran}
