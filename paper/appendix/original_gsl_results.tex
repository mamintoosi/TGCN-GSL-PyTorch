...
This appendix presents the original Graph Structure Learning (GSL) and cyclic GSL (cGSL) results that motivated the multi-lag investigation. Method naming in this appendix follows the original submission; these results were produced under the original study's protocol and are not directly comparable in RMSE magnitude to the main-text tables, which use the revised pipeline.
