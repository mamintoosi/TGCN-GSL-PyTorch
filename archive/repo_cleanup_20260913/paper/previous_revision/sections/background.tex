...
GCNs extend convolution to graph-structured data through a layer-wise propagation rule, due to Kipf and Welling \citep{kipf2017semi}:
\begin{equation}
